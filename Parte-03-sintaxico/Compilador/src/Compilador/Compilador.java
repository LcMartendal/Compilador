...
public class Compilador extends javax.swing.JFrame {
    ...
    private void btCompilarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCompilarActionPerformed
        ...
        try {
            ...
            if(pos < taEditor.getText().length()-1){
                ...
                if(lexComErro.startsWith("\"")){
                    taMensagem.setText("linha " + indicaLinha(pos) + ": " 
                            + "encontrado constante_string " + e.getMessage());

                }else if(lexComErro.isBlank()){
                    taMensagem.setText("linha " + indicaLinha(pos) + ": " 
                            + "encontrado EOF esperado expressão" );
                    
                }else if(taEditor.getText().charAt(pos-1) != ' '){
                    taMensagem.setText("linha " + indicaLinha(pos) + ": " 
                            + "encontrado end " + e.getMessage());
                    
                }else taMensagem.setText("linha " + indicaLinha(pos) + ": " 
                            + "encontrado " + lexComErro + " " + e.getMessage());
            
            }else taMensagem.setText("linha "  + indicaLinha(pos-1) + ": " 
                        + "encontrado EOF esperado expressão" );
