...
import codigoGals.LexicalError;
import codigoGals.Lexico;
import codigoGals.SemanticError;
import codigoGals.Semantico;
import codigoGals.Sintatico;
import codigoGals.SyntaticError;
...
public class Compilador extends javax.swing.JFrame {
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jToolBar1, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jSplitPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 637,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 25,
                                        Short.MAX_VALUE)
                                .addComponent(tfBarraStatus, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private int indicaLinha(int posicaoDoLexema) {
        int linha = 1;

        if (posicaoDoLexema > 0) {
            int i = 0;
            int pos = 0;
            while (true) {
                pos = posicaoDoLexema - (i++);
                if (pos == 0) {
                    break;
                }
    ...
    private void btCompilarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btCompilarActionPerformed
        ...
        try {
            ...
            if (e.getMessage() == "símbolo inválido")
                taMensagem.setText("linha " + indicaLinha(e.getPosition()) + ": " + lexComErro + " " + e.getMessage());
            else
            ...
            taMensagem.setText("linha " + indicaLinha(e.getPosition()) + ": encontrado "
                    + ((lexComErro.startsWith("\"")) ? "constante_string"
                            : (lexComErro.equals("")) ? "EOF" : lexComErro)
                    + " " + e.getMessage());
